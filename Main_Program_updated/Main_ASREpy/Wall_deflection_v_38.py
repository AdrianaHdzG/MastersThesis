...
def wall_deflection(retaining_wall_depth, avg_wall_displacement, wall_deflection_shape, soil_ovalization, volumetric, x_coords=None, C1_val=None, C2_val=None):
    """
